...
const AlertDialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('flex flex-row justify-between items-center text-center sm:text-left', className)} {...props} />
);
...
const AlertDialogCancelIcon = React.forwardRef<
  React.ElementRef<typeof AlertDialogPrimitive.Cancel>,
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Cancel>
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel ref={ref} className={cn(buttonVariants({ variant: 'ghost' }), 'mt-2 sm:mt-0', className)} {...props} />
));
AlertDialogCancelIcon.displayName = AlertDialogPrimitive.Cancel.displayName;
