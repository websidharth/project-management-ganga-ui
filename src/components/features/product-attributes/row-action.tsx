...
interface ProductAttributeRowActionsProps<TData> {
  row: Row<TData>;
  editRecord: (id: number) => void;
  deleteRecord: (id: number) => void;
}

export default function ProductAttributeRowActions<TData>({ row, editRecord, deleteRecord }: ProductAttributeRowActionsProps<TData>) {
  const item = row.original as ProductAttributeDto;
