...
export default function CategoryListFilter<TData>({ table, onTextChange, resetForm }: CategoryListFilterProps<TData>) {
  ...
  return (
    <div className="flex gap-2 items-center">
      <Input placeholder="Search by name..." value={searchedText} onChange={(e) => setSearchedText(e.target.value)} className="max-w-xs" />
      {!!searchedText && (
