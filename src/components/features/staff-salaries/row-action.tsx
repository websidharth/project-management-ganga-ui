...
interface StaffSalaryListRowActionsProps<TData> {
  row: Row<TData>;
  editRecord: (id: number) => void;
  deleteRecord: (id: number) => void;
}

export default function StaffSalaryListRowActions<TData>({ row, editRecord, deleteRecord }: StaffSalaryListRowActionsProps<TData>) {
  const item = row.original as StaffSalaryDto;
