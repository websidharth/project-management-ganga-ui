...
interface ProductVariantRowActionsProps<TData> {
  row: Row<TData>;
  editRecord: (id: number) => void;
  deleteRecord: (id: number) => void;
}

export default function ProductVariantRowActions<TData>({ row, editRecord, deleteRecord }: ProductVariantRowActionsProps<TData>) {
  const item = row.original as ProductVariantDto;
